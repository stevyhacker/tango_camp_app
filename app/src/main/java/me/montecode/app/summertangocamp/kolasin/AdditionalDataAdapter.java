 ...
 */
public class AdditionalDataAdapter extends ArrayAdapter<String> {
    ...
    public AdditionalDataAdapter(Context context, int resource, ArrayList<String> scheduleList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.notificationItemTextView = (TextView) view.findViewById(R.id.notification_item_add_data_text_view);
