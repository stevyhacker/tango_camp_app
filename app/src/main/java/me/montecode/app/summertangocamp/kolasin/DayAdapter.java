...
public class DayAdapter extends ArrayAdapter<String> {
    ...
    public DayAdapter(Context context, int resource, ArrayList<String> scheduleList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.notificationItemTextView = (TextView) view.findViewById(R.id.notification_item_day_text_view);
